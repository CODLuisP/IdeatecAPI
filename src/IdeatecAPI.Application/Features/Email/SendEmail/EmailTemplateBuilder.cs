        ...
        TipoComprobante tipo, DatosComprobante datos)
    {
        ...
        var content = $"""
            ...
            <div style="border:0.5px solid #e2e8f0;border-radius:10px;overflow:hidden;margin-bottom:18px;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                  <tr>
                    ...
                    <td style="text-align:right;vertical-align:middle;">
                      <span style="background:#16a34a;color:#fff;font-size:10px;font-weight:700;
                                   padding:2px 8px;border-radius:99px;display:inline-block;">
                        {Escape(datos.EstadoSunat)}
                      </span>
                    </td>
                  </tr>
                </table>
              ...
              <div style="background:#f0fdf4;border-top:0.5px solid #bbf7d0;padding:8px 16px;">
        ...
        var content = $"""
            ...
            <div style="border:0.5px solid #e2e8f0;border-radius:10px;overflow:hidden;margin-bottom:18px;">
              ...
              <div style="background:#f0fdf4;border-top:0.5px solid #bbf7d0;padding:8px 16px;">
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                  <tr>
                    <td style="vertical-align:middle;width:12px;">
